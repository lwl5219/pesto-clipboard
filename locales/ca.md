...
| ✓ | Clear Everything (Including Starred) | Esborra-ho tot (inclosos els preferits) |
| ✓ | Clear History | Esborra l'historial |
| ✓ | Clear History (Keep Starred) | Esborra l'historial (manté els preferits) |
| ✓ | Clearing history cannot be undone. | Esborrar l'historial no es pot desfer. |
...
| ✓ | Paste automatically | Enganxa automàticament |
| ✓ | Paste immediately after selecting an item | Enganxa immediatament després de seleccionar un element |
| ✓ | Pause capture | Pausa la captura |
| ✓ | Pesto Clipboard | Pesto Clipboard |
| ✓ | Pesto Clipboard Preferences | Preferències de Pesto Clipboard |
| ✓ | Plain text mode OFF | Mode text pla DESACTIVAT |
| ✓ | Plain text mode ON | Mode text pla ACTIVAT |
