...
| ✓ | Clear Everything (Including Starred) | Tout effacer (y compris les favoris) |
| ✓ | Clear History | Effacer l'historique |
| ✓ | Clear History (Keep Starred) | Effacer l'historique (garder les favoris) |
| ✓ | Clearing history cannot be undone. | L'effacement de l'historique est irréversible. |
...
| ✓ | Paste automatically | Coller automatiquement |
| ✓ | Paste immediately after selecting an item | Coller immédiatement après la sélection d'un élément |
| ✓ | Pause capture | Suspendre la capture |
| ✓ | Pesto Clipboard | Pesto Clipboard |
| ✓ | Pesto Clipboard Preferences | Préférences de Pesto Clipboard |
| ✓ | Plain text mode OFF | Mode texte brut DÉSACTIVÉ |
| ✓ | Plain text mode ON | Mode texte brut ACTIVÉ |
