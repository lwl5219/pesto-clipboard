...
| ✓ | Error | Ошибка |
| ✓ | Failed to load clipboard history | Не удалось загрузить историю буфера обмена |
| ✓ | Failed to save clipboard item | Не удалось сохранить элемент буфера обмена |
| ✓ | Failed to search clipboard history | Не удалось выполнить поиск в истории буфера обмена |
| ✓ | Files | Файлы |
| ✓ | General | Основные |
| ✓ | Get Started | Начать |
...
| ✓ | Ignore password manager content | Игнорировать содержимое менеджера паролей |
