...
| ✓ | Clear Everything (Including Starred) | Alles wissen (inclusief favorieten) |
| ✓ | Clear History | Geschiedenis wissen |
| ✓ | Clear History (Keep Starred) | Geschiedenis wissen (favorieten behouden) |
| ✓ | Clearing history cannot be undone. | Het wissen van de geschiedenis kan niet ongedaan worden gemaakt. |
...
| ✓ | Installed via App Store | Geïnstalleerd via App Store |
| ✓ | Installed via Homebrew | Geïnstalleerd via Homebrew |
| ✓ | Installed via direct download | Geïnstalleerd via directe download |
...
| ✓ | Paste automatically | Automatisch plakken |
| ✓ | Paste immediately after selecting an item | Direct plakken na selectie van een item |
| ✓ | Pause capture | Vastleggen pauzeren |
| ✓ | Pesto Clipboard | Pesto Clipboard |
| ✓ | Pesto Clipboard Preferences | Pesto Clipboard Voorkeuren |
| ✓ | Plain text mode OFF | Platte tekst modus UIT |
| ✓ | Plain text mode ON | Platte tekst modus AAN |
...
| ✓ | Run this command to update: | Voer deze opdracht uit om te updaten: |
| ✓ | Save | Bewaar |
| ✓ | Search | Zoeken |
| ✓ | Set Your Hotkey | Stel je sneltoets in |
